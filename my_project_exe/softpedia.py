...
# Navigate to the Softpedia website
 driver.get('https://www.softpedia.com/')
 time.sleep(3)

# XPaths for the elements
 appsticklogoXPath = "//a[@title='Softpedia']"
 sidebarpolpular = "//ul[@id='hps_search']"
 sidebarprogramming = "//input[@id='hps_input']"
...
# If all conditions are satisfied, write 'open', else write 'block'
 if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
  ...
  sheet.append(["softpedia", "https://www.softpedia.com/", "open"])
 else:
  print("One or more elements are not present, adding 'block' status to Excel file")
  sheet.append(["softpedia", "https://www.softpedia.com/", "block"])

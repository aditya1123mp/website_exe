...
# Navigate to the App-Stick website
 driver.get('https://ssuitesoft.com/ssuiteportable.htm')
 time.sleep(3)

# XPaths for the elements
 appsticklogoXPath = "//div[@id='Topnavs']"
 sidebarpolpular = "//a[@class='aboutnav' and text() = 'About Us']"
 sidebarprogramming = "//a[@class='softnav' and text() = 'Software']"
...
# If all conditions are satisfied, write 'open', else write 'block'
 if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
  ...
  sheet.append(["Ssuitebladerunner", "https://ssuitesoft.com/ssuiteportable.htm", "open"])
 else:
  print("One or more elements are not present, adding 'block' status to Excel file")
  sheet.append(["Ssuitebladerunner", "https://ssuitesoft.com/ssuiteportable.htm", "block"])

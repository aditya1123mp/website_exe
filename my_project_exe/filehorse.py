...
# Navigate to the FileHorse website
 driver.get('https://www.filehorse.com/')
 time.sleep(3)

# XPaths for the elements
 appsticklogoXPath = "//button[@type='submit']"
 sidebarpolpular = "//a[contains(text(),'Latest Software Releases')]"
 sidebarprogramming = "//a[contains(text(),'Most Popular Downloads')]"
...
# If all conditions are satisfied, write 'open', else write 'block'
 if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
  ...
  sheet.append(["filehorse", "https://www.filehorse.com/", "open"])
 else:
  print("One or more elements are not present, adding 'block' status to Excel file")
  sheet.append(["filehorse", "https://www.filehorse.com/", "block"])

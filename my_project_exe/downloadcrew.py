...
# Navigate to the website
 driver.get('https://www.downloadcrew.com/')
 time.sleep(3)

# XPaths for the elements
 appsticklogoXPath = "//a[@id='headerLogo']"
 sidebarpolpular = "//button[@id='navTab_android']"
 sidebarprogramming = "//button[@id='navTab_win']"
...
# If all conditions are satisfied, write 'open', else write 'block'
 if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
  ...
  sheet.append(["downloadcrew", "https://www.downloadcrew.com/", "open"])
 else:
  print("One or more elements are not present, adding 'block' status to Excel file")
  sheet.append(["downloadcrew", "https://www.downloadcrew.com/", "block"])

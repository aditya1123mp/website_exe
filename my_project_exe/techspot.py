...
# Navigate to the TechSpot website
    driver.get('https://www.techspot.com/')
    time.sleep(3)

# XPaths for the elements
    appsticklogoXPath = "//a[contains(text(),'Trending')]"
    sidebarpolpular = "//li[@class='login']"
    sidebarprogramming = "//div[@id='reg-log-header-item-id']"
...
# If all conditions are satisfied, write 'open', else write 'block'
    if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
        ...
        sheet.append(["techspot", "https://www.techspot.com/", "open"])
    else:
        print("One or more elements are not present, adding 'block' status to Excel file")
        sheet.append(["techspot", "https://www.techspot.com/", "block"])

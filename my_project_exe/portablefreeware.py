...
# Navigate to the Portable Freeware website
    driver.get('https://www.portablefreeware.com/')
    time.sleep(3)

# XPaths for the elements
    appsticklogoXPath = "//img[@alt='The Portable Freeware Collection']"
    sidebarpolpular = "//div/ul[@class='menu-top inline right']/li/a[text() = 'Categories']"
    sidebarprogramming = "//div/ul[@class='menu-top inline right']/li/a[text() = 'News']"
...
# If all conditions are satisfied, write 'open', else write 'block'
    if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
        ...
        sheet.append(["portablefreeware", "https://www.portablefreeware.com/", "open"])
    else:
        print("One or more elements are not present, adding 'block' status to Excel file")
        sheet.append(["portablefreeware", "https://www.portablefreeware.com/", "block"])

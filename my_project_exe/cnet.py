...
# Navigate to the CNET website
 driver.get('https://www.cnet.com/')
 time.sleep(3)

# XPaths for the elements
 appsticklogoXPath = "//button[@aria-label='Search']"
 sidebarpolpular = "//div[contains(text(),'Trending')]"
 sidebarprogramming = "//div[contains(text(),'Deals')]"
...
# If all conditions are satisfied, write 'open', else write 'block'
 if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
  ...
  sheet.append(["cnet.com", "https://www.cnet.com/", "open"])
 else:
  print("One or more elements are not present, adding 'block' status to Excel file")
  sheet.append(["cnet.com", "https://www.cnet.com/", "block"])

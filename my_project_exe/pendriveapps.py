...
# Navigate to the PendriveApps website
    driver.get('https://pendriveapps.com/')
    time.sleep(3)
...
# Create a new row at the next available position
    #data_row = sheet.row_dimensions[row_count + 1]
...
# If all conditions are satisfied, write 'open', else write 'block'
    if isAppStickLogoPresent and isloginXPath and isdownloadXPath:
        ...
        sheet.append(["Pendriveapps.com", "https://pendriveapps.com/", "open"])
    else:
        print("One or more elements are not present, adding 'block' status to Excel file")
        sheet.append(["Pendriveapps.com", "https://pendriveapps.com/", "block"])
